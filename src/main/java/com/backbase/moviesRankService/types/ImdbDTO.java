...
public class ImdbDTO {
    ...
    private String internalCalulatedRate;
    ...
    public String getInternalCalulatedRate() {
        return internalCalulatedRate;
    }

    public void setInternalCalulatedRate(String internalCalulatedRate) {
        this.internalCalulatedRate = internalCalulatedRate;
    }
}
